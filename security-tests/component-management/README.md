...
As an example if you need to create a component in a root directory you don't need to provide the **dirPath**. You can
keep that empty. But if you want to test the API call of creating a component to a sub directory level you need to pass
a value for that.
...
If you execute the API call **componentCreate** you need to use those data for the rest of the API calls that related to
the component. (Deploy , Promote, Versions, BuldDetails etc)
