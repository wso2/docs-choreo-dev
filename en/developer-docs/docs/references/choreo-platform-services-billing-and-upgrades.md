# {{ product_name }} Platform Service Billing and Upgrades

{{ product_name }} bills the platform services you create, such as databases, caches, or Kafka services, as part of your existing subscription. The cost depends on the service plan and the usage of each resource. 
...
- **Fixed pricing**: Pricing is based on the selected service plan. {{ product_name }} does not charge extra for network bandwidth usage.
