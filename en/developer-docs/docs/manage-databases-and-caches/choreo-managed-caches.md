...
- You can find the connection parameters in the **Overview** section in the {{ product_name }} Console under the relevant database. Note that {{ product_name }}-Managed Cache enforces TLS.
