...
- Build and deploy the service in Choreo using the `Node.js` build presets. The service runs on port 8080.
- Test the service.
...
4. Select the **NodeJS** build presets.
...
You have successfully created a Service component using the NodeJS build presets. Now, let's build and deploy the service.
