...
{{ product_name }} provides an extensive collection of samples for a wide range of use cases. You can quickly deploy and explore these samples to easily understand the core functionalities of the platform.
...
## Explore the {{ product_name }} samples collection

You can filter and explore {{ product_name }}'s sample collection based on your preference.

To view available samples, follow these steps:

1. Sign in to the [{{ product_name }} Console](https://console.choreo.dev/).
2. In the {{ product_name }} Console header, go to the **Project** list and select your project to open its **Overview** page.
