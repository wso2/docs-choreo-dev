...
1. In the **Lifecycle** page, click **Go to Devportal**. This takes you to the `HR API` in the {{ product_name }} Developer Portal.
...
Now, you have gained hands-on experience creating, deploying, testing, and publishing an API proxy using {{ product_name }} API Manager.

To learn more about the API management capabilities supported by {{ product_name }} API Manager, see [API Management](../api-management/lifecycle-management.md).
