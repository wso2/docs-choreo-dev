...
- Create a component to expose an integration using a sample from the [Choreo samples repository](https://github.com/wso2/choreo-samples).
...
!!! note
    To develop integrations for **Manual Task** and **Schedule Task** components in Choreo, use the **automation mode** in the WSO2 Micro Integrator. See [Running MI in Automation Mode](https://mi.docs.wso2.com/en/latest/install-and-setup/install/running-the-mi-in-automation-mode/).
...
8. Click **Create and Deploy**. Choreo initializes the component, builds it, and deploys it to the development environment.
...
1. In the Choreo Console left navigation menu, click **Observability** and then select one of the following options to monitor the performance of the integration component:
