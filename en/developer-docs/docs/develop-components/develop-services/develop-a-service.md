...
{{ product_name }} allows you to create and deploy applications in your preferred programming language.
...
- Deploy the service in {{ product_name }} using a `Go` build preset. The service will run on port 9090.
- Test the service.
...
2. Fork the [{{ product_name }} samples repository](https://github.com/wso2/choreo-samples/), which contains the [sample greetings service](https://github.com/wso2/choreo-samples/tree/main/greeting-service-go) implementation in `Go`.
