...
- Deploy an stdio-based [github-mcp-server](https://github.com/github/github-mcp-server) in Choreo  over SSE (Server-Sent Events) using a `NodeJs` build presets.
...
6. Select **NodeJs** as the build presets.
