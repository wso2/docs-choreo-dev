...
| **Detailed access log**         | By default, logs related to the mediation application are generated and can be viewed as ![Detailed access log setting](../../assets/img/api-management/api-policies/advanced-settings/detailed-access-log-setting.png). You can disable these logs if necessary.      | Set the `detailedAccessLog` parameter in the **Advanced Settings** field. <br> [runtime logs](../../monitoring-and-insights/view-logs.md#runtime-logs)  | Logs related to the mediation application will not be generated.    |
