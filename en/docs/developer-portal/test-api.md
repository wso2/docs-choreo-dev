...
6. From the dropdown, select the relevant **Subscribed Application** that you subscribed the API to. To learn how to subscribe to an application, see [Manage Subscriptions](../manage-subscription/). 
...
11. Once the Choreo executes the request, you can view the response in the console.  
