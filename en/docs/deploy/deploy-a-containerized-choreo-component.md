...
8. Click **Create**.
    ...
    - When you create a Ballerina component, Choreo allows you to develop it and define variables for which you can provide values when you deploy it. However, when you bring your own non-Ballerina component, the build process occurs via the Dockerfile. If you want to define configurable values before deploying, you must go to the **Deploy** view of the component, click **Configs and Secrets**, and then add the necessary configurations. For more information, see [Manage Configurations and Secrets](./devops/configs-and-secrets.md)
...
If you want to view Kubernetes-level insights to perform a more detailed diagnosis of this Dockerfile-based REST API, see [Runtime Details](./devops/runtime.md).
