...
To learn more about how to observe the REST API, see [Observability](../../observe-and-analyze/observe/observability-overview.md).

## Step 6: View business insights

When your API is in production, you can analyze it to understand its usage.

To learn more about how you can view insights and analyze statistics, see [Business Insights](../../observe-and-analyze/analyze/view-api-insights.md).
