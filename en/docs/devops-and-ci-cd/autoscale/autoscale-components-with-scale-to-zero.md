...
- Currently, scheduled task or manually trigger type components are unable to connect to project-scope endpoints of an service. To work around this limitation, you can either use an organization-level endpoint or a public endpoint when connecting from a scheduled task or manually trigger component.
