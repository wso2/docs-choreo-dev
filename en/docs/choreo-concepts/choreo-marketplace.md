...
- **How to use**: Includes instructions on how to use the selected service. This includes instructions on [creating a connection](../develop-components/sharing-and-reusing/create-a-connection.md) and [consuming this service](../develop-components/sharing-and-reusing/sharing-and-reusing-services.md). This section is accessible for any connections that you create.
