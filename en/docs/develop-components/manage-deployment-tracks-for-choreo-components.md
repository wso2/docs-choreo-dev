...
!!! info
     When you relink a branch that you have not used previously for an active deployment, it requires performing a manual build and deployment for the associated deployment track.
