window.__RUNTIME_CONFIG__ = {
    ASGARDEO_CONFIG: {
        ...
        signInRedirectURL: 'https://wso2.com/choreo/docs/observe-and-analyze/analyze/graphiql-explorer/',
        signOutRedirectURL: 'https://wso2.com/choreo/docs/observe-and-analyze/analyze/graphiql-explorer/',
