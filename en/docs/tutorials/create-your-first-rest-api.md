...
1. Sign in to the Choreo Console at <a  href="https://console.choreo.dev/" onclick="appInsights.trackEvent({name: 'choreo-docs-rest-api-product-link'});">https://console.choreo.dev/</a>.
