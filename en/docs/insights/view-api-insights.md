...
Optionally the geo map data can be downloaded in a tabular format using the PDF or CSV download options using the <img src="/static/media/insights-download-report.b8734963.svg" alt="download icon"> on top right corner.
