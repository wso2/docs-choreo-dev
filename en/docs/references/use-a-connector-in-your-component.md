...
1. Create a new git branch for the new connector patch version in your GitHub repo. If you are using a Choreo-managed repo, follow the steps below:
    ...
    3. Click the **Edit Code** button and navigate to the online code editor to create a new branch through the terminal using the following commands: 
        ```
...
4. Continue to deploy component by clicking **Deploy** on the **Build Area** pane.
