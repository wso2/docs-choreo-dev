...
!!! info "Note"
     - Kafka service creation is available only for paid {{ product_name }} organizations.
...
- {{ product_name }} secures Kafka connections via client certificate authentication.

- To connect to your {{ product_name }}-managed Kafka service, use the connection parameters from the **Overview** tab on the service details page.
