...
To use a third-party service in {{ product_name }}, you need to register it. Once registered, the service becomes available in the Internal Marketplace, allowing developers to consume it via a Connection.
...
1. In the {{ product_name }} Console left navigation menu, click **DB & Services** and then click **Third-Party Services**.
