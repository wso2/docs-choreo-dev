...
In {{ product_name }}, Platform Engineers can [configure approvals for workflows](../workflows/configure-approvals-for-choreo-workflows.md) and assign specific users as approvers.
...
1. Follow the instructions in the [View workflow approval requests](#view-workflow-approval-requests) section above to see details of the workflow you want to review.
   Alternatively, click the {{ product_name }} Console link in the approval request email notification you received. This takes you to the request details in the {{ product_name }} Console.
