...
Now that you understand the access control concepts in {{ product_name }}, see [Configure Access Control](../user-management/groups-and-roles/configure-access-control.md) for a walkthrough on how to set it up.