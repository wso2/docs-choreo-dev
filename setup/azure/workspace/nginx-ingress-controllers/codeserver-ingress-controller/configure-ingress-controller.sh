...
openid_connect_configuration_path="codeserver-ingress-controller/nginx-openid-connect-resources/openid_connect_configuration.conf"
openid_connect_path="codeserver-ingress-controller/nginx-openid-connect-resources/openid_connect.js"
openid_connect_server_path="codeserver-ingress-controller/nginx-openid-connect-resources/openid_connect.server_conf"
zone_sync_path="codeserver-ingress-controller/nginx-openid-connect-resources/zone_sync.conf"
...
############### Apply HPAs and PDBs #############################
export INGRESS_CONTROLLER_INSTANCE="${WORKSPACE_INGRESS_NAMESPACE}"
export INGRESS_CONTROLLER_DEPLOYMENT="${WORKSPACE_INGRESS_NAMESPACE}-nginx-ingress"
export INGRESS_CONTROLLER_NAMESPACE="${WORKSPACE_INGRESS_NAMESPACE}-nginx-plus-ingress"

echo "--- Enable HPA for Nginx Plus Ingress Controller"
kubectl apply -f ../../../nginx-plus-ingress-controller/hpa.yaml

echo "--- Enable PDB for Nginx Plus Ingress Controller"
kubectl apply -f ../../../nginx-plus-ingress-controller/pdb.yaml
