...
######################################################################################################
### Install Control Plane Internal Nginx Ingress Controller for Analytics connection using Helm 3 ###
######################################################################################################
...
helm upgrade --install "${INTERNAL_CHOREO_CONTROLPLANE_INGRESS_NAMESPACE}" ingress-nginx-4.7.0.tgz \
