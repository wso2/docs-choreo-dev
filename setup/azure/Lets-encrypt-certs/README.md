...
Add the reflector annotations to state the namespaces the tls secret should be copied. [Ref](https://github.com/emberstack/kubernetes-reflector/tree/v5.0.10)
```bash
