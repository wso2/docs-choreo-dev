...
PAYLOAD='{"callbackUrl":"http://localhost:9090","clientName":"choreo_step_aggregator","owner":"--APP_OWNER--","grantType":"client_credentials","saasApp":true}'
...
echo "Configure the above two values in service configs"
