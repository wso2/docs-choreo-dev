...
function util.getUserEnv(orgdetails)
    ...
    if orgdetails ~= nil then
        ...
        -- Get the length - 1 th element of the array. Because the environment is dev-internal
        -- b554e001-761c-4d3a-a7a6-a61d73d34221-dev-internal should return dev
        if #splitOrgDetails > 5 then
          userEnv = splitOrgDetails[#splitOrgDetails - 1]
