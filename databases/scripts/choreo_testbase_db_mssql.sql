-- Create User
IF NOT EXISTS (SELECT * FROM sys.database_principals WHERE name = N'choreo_testbase_db_user')
BEGIN
    CREATE USER [choreo_testbase_db_user] FOR LOGIN [choreo_testbase_db_user]
