...
BEGIN
    CREATE USER [choreo_url_mgt_db_user] with password = N'${choreo-url-mgt-db-mssql-password}'
...
CREATE TABLE [Cluster] (
	...
	[public_ingress_class_name] VARCHAR(191) NOT NULL,
	[organization_ingress_class_name] VARCHAR(191) NOT NULL,
	[public_nginx_service_name] VARCHAR(191) NOT NULL,
	[organization_nginx_service_name] VARCHAR(191) NOT NULL,
	[public_nginx_service_port] INT NOT NULL,
	[organization_nginx_service_port] INT NOT NULL,
