...
BEGIN
    CREATE USER [choreo_configuration_mapping_service_admin_db_user] with password = N'${choreo-configuration-mapping-service-db-mssql-password}'
    GRANT SELECT, INSERT, UPDATE, DELETE, EXECUTE ON DATABASE::choreo_configuration_mapping_service_db TO choreo_configuration_mapping_service_admin_db_user
END;
GO
