...
BEGIN
    CREATE USER [choreo_app_dev_user_mgt_db_user] with password = N'${choreo-app-dev-user-mgt-db-mssql-password}'
...
CREATE TABLE ORG_USER_STORE_ASSOCIATION (
    ...
    FOREIGN KEY (USER_STORE_ID) REFERENCES USER_STORES(ID)
);
