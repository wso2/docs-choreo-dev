...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[MULTIVARIATE_ANOMALY_ALERTS]') AND TYPE IN (N'U'))
CREATE TABLE MULTIVARIATE_ANOMALY_ALERTS  
(  
