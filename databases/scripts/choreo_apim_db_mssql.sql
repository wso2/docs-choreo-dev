-- Create User
IF EXISTS (SELECT name FROM master.sys.databases WHERE name = N'choreo_apim_db') AND NOT EXISTS (SELECT * FROM sys.database_principals WHERE name = N'choreo_apim_db_user')
BEGIN
