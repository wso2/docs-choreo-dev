...
-- Trigger to copy VALUE column to APP_ATTRIBUTE column --
CREATE TRIGGER insertAppAttribute
ON AM_APPLICATION_ATTRIBUTES AFTER INSERT
AS
BEGIN
UPDATE AM_APPLICATION_ATTRIBUTES SET APP_ATTRIBUTE = VALUE;
END
