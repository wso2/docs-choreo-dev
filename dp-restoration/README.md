...
```
bash dp-contents-restoration.sh
```
- At the end of the execution of the script, two files are produced namely `output_file.txt` and `failure_output.txt`.
The first file contains the information logs for the redeployment and the second file tracks the id of the relevant level
