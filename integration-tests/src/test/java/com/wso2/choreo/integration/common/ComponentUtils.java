...
public class ComponentUtils {
    ...
    public static ChoreoComponent getReusableComponent(TestActionRunner runner, String accessToken, String testName, 
               Map<Endpoints, HttpClient> citrusClients, ComponentFlavour componentFlavour) throws Exception {
