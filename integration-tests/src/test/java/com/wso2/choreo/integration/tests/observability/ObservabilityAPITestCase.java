...
public class ObservabilityAPITestCase extends TestNGCitrusSpringSupport {
    ...
    public void beforeClass()
            ...
            ComponentInvokeInformationCheckException, InvokeInformationNotFoundException, GenerateAPIKeyCheckException, ApiKeyNotFoundException, InvokeAPICheckException, ReleaseIdNotFoundException, ObservabilityIdNotFoundException, ObservabilityIdCheckException, ObservabilityDataNotFoundException {
